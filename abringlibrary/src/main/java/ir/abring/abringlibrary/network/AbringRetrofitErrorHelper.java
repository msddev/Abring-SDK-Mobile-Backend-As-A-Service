...
public class AbringRetrofitErrorHelper {
    ...
    public String getMessage(Object error, Context context) {
        ...
        if (error instanceof SocketTimeoutException) {
            ...
            return context.getResources().getString(R.string.no_connect_to_server);
        } else {
    ...
    private String handleServerError(Object res) {
        ...
        switch (response.code()) {
            ...
            case 404:
                return mContext.getResources().getString(R.string.ERROR_PAGE_NOT_FOUND);
            case 405: // server error
            case 500:
                return mContext.getResources().getString(R.string.no_connect_to_server);
